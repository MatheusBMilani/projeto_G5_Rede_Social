package com.projetoG5RedeSocial.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.projetoG5RedeSocial.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				...
				.licenseUrl("https://github.com/MatheusBMilani/projeto_G5_Rede_Social")
				.contact(contact())
				.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Grupo 5: Beatriz Gomes - Matheus Milani - Paulo de Matos - Sabrina Alves", 
				"https://github.com/MatheusBMilani/projeto_G5_Rede_Social", 
				"paulo.mfn@gmail.com");
	}	
